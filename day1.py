...
greeting_message="Hi! I am Suman. Good to see you here in my first python code."
print(greeting_message)

# Avoiding Name errors in code Practice
...
Var_1="I am learnig Python."
var_2="I am enjoying it."
print(Var_1)
print(var_2)
...
var_1="I am learnig Python."
var_2="I am enjoying it."
var_1="I am learning Python and loving it."
print(var_1)
print(var_2)

#practice code 1
print("Welcome to Python Crash Course World!")
print("Name:Suman Subedi") 
print("Age:23") 
